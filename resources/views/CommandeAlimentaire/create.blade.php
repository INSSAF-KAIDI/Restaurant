...
<body>
    ...
    <div class="container ">
        <div class="d-flex justify-content-between py-3">
            <div class="h4">Edit CommandeAlimentaire</div>
            <div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="NoCmd" id="NoCmd" class="form-select
                         @error('NoCmd') is-invalid @enderror">
                            ...
                            <option value="{{ $commande->id }}" {{ $commandealimentaire->commande_id== $commande->id ? "selected":'' }}>{{ $commande->NoCmd }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="NomAlimentaire" id="NomAlimentaire" class="form-select
                         @error('NomAlimentaire') is-invalid @enderror">
                            ...
                            <option value="{{ $alimentaire->id }}" {{ $commandealimentaire->alimentaire_id== $alimentaire->id ? "selected":'' }}>{{ $alimentaire->NomAlimentaire }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="prix" id="prix" class="form-select
                         @error('prix') is-invalid @enderror">
                            ...
                            <option value="{{ $size_alimentaire->id }}" {{ $commandealimentaire->size_alimentaire_id== $size_alimentaire->id ? "selected":'' }}>{{ $size_alimentaire->prix }}</option>
                            @endforeach
                        </select>
