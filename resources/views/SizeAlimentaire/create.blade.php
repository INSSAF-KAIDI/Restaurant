...
<body>
    ...
    <div class="container ">
        ...
        <form action="{{ route('sizealimentaire.store') }}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <select name="NomAlimentaire" id="NomAlimentaire" class="form-select
                         @error('NomAlimentaire') is-invalid @enderror">
                            ...
                            <option value="{{ $alimentaire->id }}" {{ old('NomAlimentaire') == $alimentaire->id ? "selected":'' }}>{{ $alimentaire->NomAlimentaire }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="Taille" id="Taille" class="form-select
                         @error('Taille') is-invalid @enderror">
                            ...
                            <option value="{{ $size->id }}" {{ old('Taille') == $size->id ? "selected":'' }}>{{ $size->Taille }}</option>
                            @endforeach
                        </select>
            ...
            <button class="btn btn-primary mt-3">Save sizealimentaire</button>
