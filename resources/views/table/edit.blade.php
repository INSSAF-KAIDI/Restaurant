...
<body>
    ...
    <div class="container ">
        ...
        <form action="{{ route('tables.update',$table->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="card border-0 shadow-lg">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="NumTable" id="NumTable" placeholder="Entrer NumTable" class="form-control @error('NumTable') is-invalid @enderror" value="{{ old('NumTable',$table->NumTable) }}">
                        @error('NumTable')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="capacite" id="capacite" placeholder="Entrer capacite" class="form-control @error('capacite') is-invalid @enderror" value="{{ old('capacite',$table->capacite) }}">
                        @error('capacite')
                            <p class="invalid-feedback">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <button class="btn btn-primary my-3">Update table</button>
