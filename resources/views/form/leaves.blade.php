    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_leave"><i class="fa fa-plus"></i> Ajouter Congé</a>
                    </div>
                </div>
            </div>
            <!-- Leave Statistics -->
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="stats-info">
                        <h6>Congés planifiés</h6>
                        <h4>8 <span>Today</span></h4>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stats-info">
                        <h6>Congés imprévus</h6>
                        <h4>0 <span>Today</span></h4>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stats-info">
                        <h6>Requests en attente</h6>
                        <h4>12</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row filter-row">
                <div class="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12">
                    <div class="form-group form-focus">
                        ...
                        <label class="focus-label">Nom Serveur</label>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12">
                    <div class="form-group form-focus select-focus">
                        <select class="select floating">
                            ...
                            <option>Congé occasionnel</option>
                            <option>Congé de maladie</option>
                            <option>Perte de salaire</option>
                        </select>
                        <label class="focus-label">Type Congé</label>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12">
                    <div class="form-group form-focus select-focus">
                        ...
                        <label class="focus-label">Status de Type Congé </label>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12">
                    <div class="form-group form-focus">
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown action-label">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="#"><i class="fa fa-dot-circle-o text-purple"></i> Nouveau</a>
                                                        <a class="dropdown-item" href="#"><i class="fa fa-dot-circle-o text-info"></i> En Attente</a>
                                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#approve_leave"><i class="fa fa-dot-circle-o text-success"></i> Approuvé</a>
                                                        <a class="dropdown-item" href="#"><i class="fa fa-dot-circle-o text-danger"></i> Diminué</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-right">
                        ...
                        <form action="{{ route('form/leaves/save') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select class="select" id="leaveType" name="leave_type">
                                    <option selected disabled>Select Type congé </option>
                                    <option value="Casual Leave 12 Days">congé occasionnel 12 Days</option>
                                    <option value="Medical Leave"> congé Medical</option>
        ...
        <div id="edit_leave" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Edit congé </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('form/leaves/edit') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label>Type congé  <span class="text-danger">*</span></label>
