            ...
            <div class="page-header">
                <div class="row align-lists-center">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_employee"><i class="fa fa-plus"></i> Ajouter Employee</a>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Ajouter Serveur</h5>
                    ...
                    <div class="modal-body">
                        <form action="{{ route('all/employee/save') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="col-form-label">Serveur ID <span class="text-danger">*</span></label>
