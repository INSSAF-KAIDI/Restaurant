                    ...
                    <div class="card-group m-b-30">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="mb-3">1,42,300 DH</h3>
                                <div class="progress mb-2" style="height: 5px;">
                                    <div class="progress-bar bg-primary" role="progressbar" style="width: 70%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <p class="mb-0">Previous Month <span class="text-muted">1,15,852 DH</span></p>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="mb-3">8,500 DH</h3>
                                <div class="progress mb-2" style="height: 5px;">
                                    <div class="progress-bar bg-primary" role="progressbar" style="width: 70%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <p class="mb-0">Previous Month <span class="text-muted">7,500 DH</span></p>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="mb-3">1,12,000 DH</h3>
                                <div class="progress mb-2" style="height: 5px;">
                                    <div class="progress-bar bg-primary" role="progressbar" style="width: 70%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <p class="mb-0">Previous Month <span class="text-muted">1,42,000 DH</span></p>
                            </div>
                        </div>
                    </div>
                </div>
